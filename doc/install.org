...
* Requirements
  ...
  - =strace=: to generate complie database
...
* Building
  ...
  #+begin_src sh
    # specilfy libclang dir if you get error about libclang
    # cmake -DLibclang_INCLUDE_DIR=/usr/local/Cellar/llvm/4.0.1/include -DLibclang_LIBRARY=/usr/local/Cellar/llvm/4.0.1/lib/libclang.dylib
